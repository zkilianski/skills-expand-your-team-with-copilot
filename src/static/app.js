document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      // If "All Levels" is selected (empty string), only show activities with no difficulty
      // If a specific difficulty is selected, only show activities with that difficulty
      if (currentDifficulty === "") {
        // "All Levels" option: only show activities with no difficulty specified (for all levels)
